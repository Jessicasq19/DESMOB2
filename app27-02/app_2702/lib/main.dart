       ...
       bottomNavigationBar: BottomNavigationBar(
        ...
        items: const <BottomNavigationBarItem>[
          BottomNavigationBarItem(
            ...
            label: 'Home',
            backgroundColor: Color.fromARGB(255, 190, 117, 233),
          ),
          BottomNavigationBarItem(
        ...
        selectedItemColor: Color.fromARGB(255, 87, 20, 126),
        onTap:showItemTrap ,
    ));
  }
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        ...
        children: [
        Center(
          child: Container(color: Colors.blue, width: 250, height: 150,
          child: Center(child: Text("SEJA BEM-VINDO À TELA INICIAL!")),),
        ),
